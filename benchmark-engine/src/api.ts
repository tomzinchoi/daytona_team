import type { ArchitecturesRequest, ArchitecturesResponse, RecommendRequest, RecommendResponse } from "./shared/types.js";
...
export function architecturesEndpoint(input: unknown): ArchitecturesResponse {
  ...
  const candidateArchitectures = generateArchitectures(input.workload);
